...
/**
 * This javascript object current takes JavascriptObjects as parameters, but returns JSObjects, as it doesn't know what
...
public class MVCArray extends JavascriptObject {
    ...
    /**
     * Iterates over the elements within the array, calling the supplied function for each member. The parameters to the
     * callback function are: func(element, index)
     *
     * @param func
     */
