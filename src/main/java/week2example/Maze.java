...
public class Maze {
    ...
    */
    ...
    /**
     * Link the nodes that are adjacent (and not null) to each other with an edge. There is an edge between any two
     * adjacent nodes up, down, left or right.
     */
     ...
     *
     * @return the path from starting position to ending position, or an empty list if there is no path.
     */
