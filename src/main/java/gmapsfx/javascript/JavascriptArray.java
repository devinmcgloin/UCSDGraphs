 ...
 * to the array as a JavascriptObject. The caller is then responsible for wrapping any new JSObjects in the appropriate
 * JavascriptObject, as they should know what is needed.
 * <p/>
 *
 * @author Geoff Capper
 */
public class JavascriptArray extends JavascriptObject {
    ...
    /**
     * Get the length of the array. This returns the value from the underlying Javascrpt object.
     *
     * @return
     */
    public int length() {
