...
/**
 * Builds a Polygon or Polyline in the shape of an Arc. Based on the logic in v3_polygon_exanple_arc.html from
 * http://econym.org.uk/gmap/ which is based in turn on the Latitude/longitude spherical geodesy formulae and scripts at
...
public class ArcBuilder {
     ...
     *
     * @return An array of LatLong points in an MVC array representing the arc. Using this method directly you will need
     * to push the centre point onto the array in order to close it, if desired.
     */
