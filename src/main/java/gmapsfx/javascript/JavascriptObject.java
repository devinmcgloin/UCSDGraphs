...
public class JavascriptObject {
    ...
    /**
     * Builds a new JavascriptObject based on a string representation of the object. This is useful when constructing
     * functions as objects
     *
     * @param type                 The type of object to build
     * @param stringRepresentation A string representation of the object, which can be executed by the Javascript
     *                             runtime.
     */
     ...
     * @param isArray boolean to indicate the an array is to be used as the parameter rather than breaking up into
    ...
    /**
     * JSObject will return the String "undefined" at certain times, so we need to make sure we're not getting a value
