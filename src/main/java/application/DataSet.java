...
/**
 * Class to wrap the graph, current .map file map, and other pertinent information about the map data sets
 *
...
public class DataSet {
    ...
    /**
     * Return the intersections in this graph. In order to keep it consistent, if getVertices in the graph returns
     * something other than null (i.e. it's been implemented) we get the vertices from the graph itself.  But if the
     * graph hasn't been implemented, we return the set of intersections we separately maintain specifically for this
     * purpose.
     *
