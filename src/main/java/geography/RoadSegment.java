...
/**
 * A segment of the road that includes the intersection end points as well as all the minor points that make up the
...
public class RoadSegment {
    ...
    /**
     * Two road segments are equal if they have the same start and end points and they have the same road name.
     */
