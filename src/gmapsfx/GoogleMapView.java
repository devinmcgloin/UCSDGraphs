...
public class GoogleMapView extends AnchorPane {
    ...
    /**
     * Allows for the creation of the map using external resources from another jar for the html page and markers. The
     * map html page must be sourced from the jar containing any marker images for those to function.
     * <p/>
     * The html page is, at it's simplest: {@code <!DOCTYPE html> <html> <head> <meta name="viewport"
     * content="initial-scale=1.0, user-scalable=no"> <meta charset="utf-8"> <title>My Map</title> <style> html, body,
     * #map-canvas { height: 100%; margin: 0px; padding: 0px } </style> <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
     * </head> <body> <div id="map-canvas"></div> </body> </html> }
     * <p/>
     * If you store this file in your project jar, under my.gmapsfx.project.resources as mymap.html then you should call
     * using "/my/gmapsfx/project/resources/mymap.html" for the mapResourcePath.
     * <p/>
     * Your marker images should be stored in the same folder as, or below the map file. You then reference them using
     * relative notation. If you put them in a subpackage "markers" you would create your MarkerOptions object as
     * follows: {@code myMarkerOptions.position(myLatLong) .title("My Marker") .icon("markers/mymarker.png")
     * .visible(true); }
     *
