...
public class LatLong extends JavascriptObject {
    ...
    /**
     * Calculates the LatLong position of the end point of a line the specified distance from this LatLong, along the
     * provided bearing, where North is 0, East is 90 etc.
     *
